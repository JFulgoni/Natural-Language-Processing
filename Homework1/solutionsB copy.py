...
def viterbi(brown_dev_words, taglist, known_words, q_values, e_values):
    ...
    for sentence in brown_dev_words:
        ...
        for t in range (1, sentence_length + 1):
            ...
            # for a better taglist, we can see where the word shows up in the emission table
            # better_taglist = set([])
            # for tagerino in taglist:
            #     if (current_word, tagerino) in e_values.keys():
            #         better_taglist.add(tagerino)
